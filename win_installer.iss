...
[Icons]
Name: "{group}\bailiskLLM"; Filename: "{app}\basiliskllm.exe"; WorkingDir: "{app}"
Name: "{autodesktop}\basiliskLLM"; Filename: "{app}\basiliskllm.exe"; WorkingDir: "{app}"; Tasks: DesktopIcon
Name: "{autostartup}\basiliskLLM"; Filename: "{app}\basiliskllm.exe"; WorkingDir: "{app}"; Tasks: StartupIcon
[Run]
