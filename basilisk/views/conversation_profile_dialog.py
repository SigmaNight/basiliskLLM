...
class EditConversationProfileDialog(wx.Dialog, BaseConversation):
	...
	def init_ui(self):
		...
		self.sizer.Add(self.reasoning_mode, 0, wx.ALL | wx.EXPAND, 5)
		self.sizer.Add(self.reasoning_adaptive, 0, wx.ALL | wx.EXPAND, 5)
		self.sizer.Add(self.reasoning_budget_label, 0, wx.ALL, 5)
		self.sizer.Add(self.reasoning_budget_spin, 0, wx.ALL | wx.EXPAND, 5)
		self.sizer.Add(self.reasoning_effort_label, 0, wx.ALL, 5)
		self.sizer.Add(self.reasoning_effort_choice, 0, wx.ALL | wx.EXPAND, 5)
