...
class TestErrorDisplayMixin:
	...
	def test_show_error_calls_messagebox(self, mixin_instance, mocker):
		"""show_error should delegate to wx.MessageBox."""
		mock_wx = mocker.patch("basilisk.views.view_mixins.wx")
		mock_wx.OK = 4
	...
	def test_show_error_default_title(self, mixin_instance, mocker):
	...
	def test_show_enhanced_error_delegates_to_dialog(
		self, mixin_instance, mocker
	):
		"""show_enhanced_error should call show_enhanced_error_dialog."""
		mock_dialog = mocker.patch(
			"basilisk.views.view_mixins.show_enhanced_error_dialog"
		)
	...
	def test_show_enhanced_error_default_args(self, mixin_instance, mocker):
		"""show_enhanced_error default is_completion_error=False."""
		mock_dialog = mocker.patch(
			"basilisk.views.view_mixins.show_enhanced_error_dialog"
		)
		mixin_instance.show_enhanced_error("msg")
		mock_dialog.assert_called_once_with(mixin_instance, "msg", None, False)
